...
key_name    = 'Outsource_seveneleven'
script_key  = 'dqDdhlylvudlj3l~umilygkis'

sg = shotgun_api3.Shotgun(domain_link, key_name, script_key)
...
def getShotgunUser():
    users = sg.find_one('HumanUser', [['name','is', getpass.getuser()]], ['name','department'])
    return users
